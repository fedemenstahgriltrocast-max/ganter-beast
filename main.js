(function () {
  ...
  const translations = {
    en: {
      ...
      galleryTitle: 'Signature mornings',
      gallerySubtitle: "Slide through the flavors fueling Guayaquil's mornings.",
      galleryHint: 'Swipe or use your mouse wheel to explore the gallery.',
    ...
    es: {
      ...
      galleryTitle: 'Mañanas emblemáticas',
      gallerySubtitle: 'Desliza por los sabores que energizan las mañanas de Guayaquil.',
      galleryHint: 'Desliza o usa la rueda del mouse para explorar la galería.',
      ...
      galleryImage3Alt: 'Tortilla dorada sobre una tabla de servir',
      galleryImage4Alt: 'Huevos fritos servidos con salchicha',
      galleryImage5Alt: 'Botella de Pepsi fría con hielo',
      galleryImage6Alt: 'Botella de Seven Up sobre hielo picado',
